...
export const PROFILE_DATA = {
  ...
  about: "Mechatronics student and developer bridging the gap between hardware and software. I create practical, automated solutions for industrial and community challenges.",
  cvUrl: "#",
};
