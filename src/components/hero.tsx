      ...
      <div className="container min-h-screen flex flex-col items-center justify-center pt-24 pb-12">
        <div className="w-full">
          ...
          <div className="flex items-center justify-between">
             <h1 className="text-[10vw] md:text-[12vw] lg:text-[10rem] font-black leading-none tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-b from-foreground from-70% to-primary">
              Developer
            </h1>
